...
<body>
	<div class="signup-form">
		<form id="myform" class="modal-content" method="post" action="#" enctype="multipart/form">
			<div class="row">
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<label class="col-form-label col-4">Upload file</label>

					<input type="file" class="form-control fdsfs" name="file" />
				</div>
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (data == '1') {
						...
						toastr.warning('something else wrong try again !');


					} else {
						toastr.warning('file not upload ');
